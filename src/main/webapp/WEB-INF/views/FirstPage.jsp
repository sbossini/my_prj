...
<body>
			...
			<div class="container">
				...
				<div id="nav-menu" class="navbar-collapse collapse"
					...
					<ul class="nav navbar-nav clean-menu-wrapper">
						<li class="active"><a href="#clean-slider">Home</a></li>
						<li><a href="#about">About</a></li>
						<li><a href="#featured-works">Featured Works</a></li>
						<li><a href="#offer">Features</a></li>
		...
		<div class="sp-slides">
			...
			<div class="sp-slide clean-main-slides">
				...
				<h1 class="sp-layer clean-slider-text-big" data-position="center"
					...
					data-show-delay="1500" data-hide-delay="200">
					<span class="clean-color-contras">CLEAN</span> - Slider Responsive
					HTML Template
				</h1>
				<p class="sp-layer" data-position="center" data-vertical="15%"
					data-show-delay="2000" data-hide-delay="200"
					data-show-transition="left" data-hide-transition="down">Lorem
	...
	<section id="about" class="clean-section-wrapper background-one">
		<div class="container">
			<div class="row">
				...
				<!-- Section Header -->
				<div
					class="col-md-12 col-sm-12 col-xs-12 clean-section-header wow fadeInDown">
					<h1>
						<span class="clean-color-contras">ABOUT OFFERS</span>
					</h1>
					<div class="clean-line"></div>
					<p
						class="col-md-8 col-sm-10 col-xs-12 col-md-offset-2 col-sm-offset-1">Lorem
						ipsum dolor sit amet, consectetur adipisicing elit. Officia
						voluptas voluptatem est nobis quibusdam, laboriosam ipsam porro
						nesciunt quae officiis rem deserunt, nisi magni unde ipsa labore!
						Maiores, necessitatibus, facilis!</p>
				</div>
				<!-- Section Header End -->
				...
				<div class="clean-what-we-do">
					...
					<div
						class="col-md-3 col-sm-3 col-xs-12 clean-blurb-round-icon wow bounceInLeft">
						<div class="clean-icon">
							<i class="fa fa-html5"></i>
						</div>
						<h3>HTML TEMPLATE</h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
							Id voluptatibus placeat vel minima quia earum eaque repellendus
							odio beatae suscipit.</p>
					</div>

					<div
						class="col-md-3 col-sm-3 col-xs-12 clean-blurb-round-icon wow bounceIn"
						data-wow-delay=".5s">
						<div class="clean-icon">
						...
						<h3>CSS3</h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
							Harum, nostrum animi est error facere ipsum laboriosam, rem modi
							totam earum.</p>
					</div>
					...
					<div
						...
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
							Repudiandae laudantium, aperiam! Impedit nam atque reiciendis
							itaque, ab in vitae sit.</p>
					</div>

					<div
						class="col-md-3 col-sm-3 col-xs-12 clean-blurb-round-icon wow bounceInRight"
						data-wow-delay=".5s">
						<div class="clean-icon">
						...
						<h3>FREE SUPPORT</h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
							Aspernatur libero vel deserunt nulla voluptatibus consequuntur
							adipisci quae. Facere, vero!.</p>
					</div>
		...
		<div class="container">
			<div class="row">
				...
				<div
					class="col-md-12 col-sm-12 col-xs-12 clean-section-header wow fadeInDown">
					<h1>
						<span class="clean-color-contras">SCREENSHOOT</span>
					</h1>
					<div class="clean-line"></div>
					<p
						class="col-md-8 col-sm-10 col-xs-12 col-md-offset-2 col-sm-offset-1">`Lorem
						ipsum dolor sit amet, consectetur adipisicing elit. Repellat at,
						totam, nam aspernatur voluptatum nostrum officiis deserunt nisi
						quibusdam ipsam?</p>
				</div>
				<!-- Section Header End -->
				...
				<div
					class="col-md-6 col-sm-6 col-xs-12 clean-custom-sec-text wow bounceInRight">
					<h3>Lorem ipsum dolor sit amet.</h3>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
						Aliquam aut tenetur, amet earum quia eligendi obcaecati.
						Repudiandae id illum, vero iste enim reprehenderit quaerat, harum
						pariatur ipsa nulla tempora ex ratione illo assumenda libero ea,
						delectus vitae, expedita optio porro.</p>
	...
	<section id="featured-works" class="clean-section-wrapper">
		...
		<div class="container">
			<div class="row">
				...
				<div
					class="col-md-12 col-sm-12 col-xs-12 clean-section-header wow fadeInDown">
					<h1>
						<span class="clean-color-contras">FEATURED WORK</span>
					</h1>
					<div class="clean-line"></div>
					<p
						class="col-md-8 col-sm-10 col-xs-12 col-md-offset-2 col-sm-offset-1">Lorem
						ipsum dolor sit amet, consectetur adipisicing elit. Magnam itaque
						enim aliquid praesentium odio dolorum sunt. Aperiam delectus,
						eligendi assumenda!</p>
				</div>
				<!-- Section Header End -->
		...
		<div class="container-fluid">
			<div class="row-fluid">
				...
				<div class="clean-portfolio-work-slider-section wow fadeIn"
					data-wow-duration="2s">
					<div id="featured-work-slider"
						class="owl-carousel clean-portfolio-works-slider">
    ...
    ==================================== -->
	<section id="offer"
		class="clean-section-wrapper clean-offer-section  background-two">
		<div class="container">
			<div class="row">
				...
				<div
					class="col-md-12 col-sm-12 col-xs-12 clean-section-header wow fadeInDown">
					<h1>
						<span class="clean-color-contras">FEATURES</span>
					</h1>
					<div class="clean-line"></div>
					<p
						class="col-md-8 col-sm-10 col-xs-12 col-md-offset-2 col-sm-offset-1">Lorem
						ipsum dolor sit amet, consectetur adipisicing elit. Delectus
						tempore voluptatem dolor cum autem qui maiores esse sit, vel
						voluptate.</p>
				</div>
				<!-- Section Header End -->
				...
				<div class="clean-service-wrapper">
					<div class="col-md-4 col-sm-4 col-xs-12 wow bounceInLeft">
						...
						<div class="clean-blurb-icon-only">
							...
							<h3>HTML5</h3>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
								Modi tempora quis numquam odio. Asperiores perspiciatis maiores
								voluptas, velit similique placeat.</p>
						</div>
		...
		<div class="container">
			<div class="row">
				...
				<div
					class="col-md-12 col-sm-12 col-xs-12 clean-section-header wow fadeInDown">
					<h1>
						<span class="clean-color-contras">PRICE</span>
					</h1>
					<div class="clean-line"></div>
					<p
						class="col-md-8 col-sm-10 col-xs-12 col-md-offset-2 col-sm-offset-1">Lorem
						ipsum dolor sit amet, consectetur adipisicing elit. Molestiae
						dolorem nostrum pariatur consequatur aut est aspernatur reiciendis
						veniam delectus saepe.</p>
				</div>
				<!-- Section Header End -->
				...
				<div class="clean-pricing-wrapper">
					...
					<!-- Plans -->
					<div
						class="col-md-4 col-sm-4 col-xs-12 clean-pricing-plans wow bounceInLeft">
					...
					<!-- Plans -->
					<div
						class="col-md-4 col-sm-4 col-xs-12 clean-pricing-plans clean-recommended-pricing wow fadeInUp"
						data-wow-duration="1s">
						<div class="clean-pricing-titles">
							<h2>BASIC</h2>
							<p>
					...
					<!-- Plans -->
					<div
						class="col-md-4 col-sm-4 col-xs-12 clean-pricing-plans wow bounceInRight">
						<div class="clean-pricing-titles">
							<h2>PREMIUM</h2>
							<p>
								<span>$45/</span>Month
	...
	<section id="testimonial"
		class="clean-testimonial-section background-two">
					...
					<div id="clean-testimonial" class="owl-carousel clean-testimonial">
						...
						<div
							...
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
								...
								nemo veritatis repellat impedit provident, sapiente magni
						...
						<div
							...
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
								Temporibus eum quasi illum, impedit perspiciatis saepe officiis
								dolore alias expedita et obcaecati doloremque, quis ipsam
						...
						<div
							...
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
								...
								magni mollitia perferendis accusantium quis, totam quaerat,
								reprehenderit officia explicabo. Cum cupiditate error temporibus
								blanditiis.</p>
    ...
    ==================================== -->
	<section id="contact"
		class="clean-section-wrapper clean-contact-section background-one"
		...
		<div class="container">
			<div class="row">
				...
				<!-- Section Header -->
				<div
					class="col-md-12 col-sm-12 col-xs-12 clean-section-header wow fadeInDown clean-section-header-parallax">
					<h1>
						<span class="clean-color-contras">CONTACT US</span>
					</h1>
					<div class="clean-line"></div>
					<p
						class="col-md-8 col-sm-10 col-xs-12 col-md-offset-2 col-sm-offset-1">Lorem
						ipsum dolor sit amet, consectetur adipisicing elit. Laborum error
						ab rem atque impedit soluta quidem, deleniti culpa. Accusantium
						placeat commodi harum, aut cumque numquam molestiae vel ut eum
						consequuntur.</p>
				</div>
				<!-- Section Header End -->
				...
				<div class="clean-contact-details">
					...
					<!-- Contact Form -->
					<div
						class="col-md-12 col-sm-12 col-xs-12 clean-contact-form wow bounceInRight">
		...
		<div class="container">
			<div class="row">
				<div class="clean-footer-content">
					...
					<p class="clean-copyright-info">©2015 CLEAN - Slider Responsive
						HTML Template</p>
